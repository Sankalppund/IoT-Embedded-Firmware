...
void i2c_init()
{
	...
	I2CSPM_Init_TypeDef config_i2c = I2CSPM_INIT_DEFAULT;      // Initializing the driver instances."Polling"
 ...
 */
	...
	Value = ((175.72*(temp_Sen_Value)/65536) - 46.85);
	   ...
	   LOG_INFO( "\n\nTimestamp = %d",loggerGetTimestamp());
       LOG_INFO("\n\nTemperature_in_degree_Celsius =  %f ",Value);
