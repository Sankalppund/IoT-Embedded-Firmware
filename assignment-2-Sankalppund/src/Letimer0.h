...
#define Time_Period_1 (2250)  // Enter Total time period value in milliseconds.
#define LED_On_Time_2 (175)   // Enter LED_ON time period value in milliseconds.
#define Energy_Mode (1)       // Enter Value 0,1,2,3 for Energy Mode EM0,EM1, EM2 & EM3 respectively.
